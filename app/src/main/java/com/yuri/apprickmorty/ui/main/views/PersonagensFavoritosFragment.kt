 ...
 * Use the [PersonagensFavoritosFragment.newInstance] factory method to
...
class PersonagensFavoritosFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PersonagensFavoritosFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PersonagensFavoritosFragment().apply {
